...
func WebStart(app controller.Application) {
	...
	http.HandleFunc("/api/v1/task/start_multi_FedMDH", app.StartTask_FedMDH)
	...
	http.HandleFunc("/api/v1/task/getSingleResult_FedMDH", app.GetSingleResult_FedMDH)
	http.HandleFunc("/api/v1/task/getMultiResult_FedMDH", app.GetMultiResult_FedMDH)
