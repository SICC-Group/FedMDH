        ...
        <div className='flex-center card-wrapper'>
          <div className='card'>
            ...
            <div className='button-wrapper'>
              <ul>
                <li>
                  <Button loading={this.state.requesting} size='large' type='primary' href='javascript:void(0)' onClick={this.onButtonClick}>
                    {/*{_('Login')}*/}
                    {'Login'}
                  </Button>
                ...
                <li>
                  <Button loading={this.state.requesting} size='large' type='primary' href='javascript:void(0)' onClick={this.onsignButtonClick}>
                    {/*{_('Login')}*/}
                    {'signup'}
                  </Button>
                </li>
    ...
    fetch('http://localhost:8000/api/v1/account/register/', {
      ...
      if (res.ok) {
        ...
        if (next && next.startsWith('/')) {
          ...
          window.location.href = Urls.search_page;
        }
        return;
      }
      else { // 不OK的情况下是数据内容的错误
