...
const FederatedComputing: FC<any> = () => {
    ...
    const [fedMethod,setFedMethod] = useState<string>('');
                ...
                <FormPage
                    ...
                    <div style={{ margin: '24px' }}>
                        ...
                        >
                            ...
                            <Form.Item label={<FormattedMessage id='FedMethod' defaultMessage="联邦学习方法" />}>
                                <Select placeholder="请选择一种方法" value={fedMethod} onChange={(value: string) => setFedMethod(value)}>
                                    <Select.Option value="FedAvg">FedAvg</Select.Option>
                                    <Select.Option value="FedMDH">FedMDH</Select.Option>
                                </Select>
                            </Form.Item>
